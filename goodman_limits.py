...
g1p_M1q = t.calc_cN_scalar(g1u_limit,g1d_limit,g1s_limit,0.,p.data_p)
g1n_M1q = t.calc_cN_scalar(g1u_limit,g1d_limit,g1s_limit,0.,p.data_n)

# limits on nucleon couplings from gluon couplings (M7):
g1p_M7G = t.calc_cN_scalar(0.,0.,0.,g7G_limit,p.data_p)
g1n_M7G = t.calc_cN_scalar(0.,0.,0.,g7G_limit,p.data_n)
...
# maybe ok.
g10p_M3q = t.calc_cN_pseudoscalar(g3u_limit,g3d_limit,g3s_limit,0,p.data_p)
g10n_M3q = t.calc_cN_pseudoscalar(g3u_limit,g3d_limit,g3s_limit,0,p.data_n)

g10p_M9G = t.calc_cN_pseudoscalar(0,0,0,g9G_limit,p.data_p)
g10n_M9G = t.calc_cN_pseudoscalar(0,0,0,g9G_limit,p.data_n)
